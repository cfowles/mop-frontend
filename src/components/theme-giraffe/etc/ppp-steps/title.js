...
const Title = ({ toggleOpen, updateStateFromValue, step, title }) => (
    <div className={cx("title", "ppp-step", "container", step == 1 ? "active" : "")}>
        <div className="row ppp-item">
            ...
            <InputMaterial name="title" type="text" className="bg-ice-blue" placeholder="Your Petition Title" charLimit={50} stateRef={title} onChange={updateStateFromValue("title")} />
        </div>
